...
const passwordRecoveryEmail = async (datos) => {
    ...
    await transport.sendMail({
        from: 'BienesRaices.com',
        to: email,
        subject: 'Recupera tu contraseña de Bienes Raices',
...
<body>
    ...
    <main class="main">
        <div class="confirmation-box">
            <h2>Recupera tu cuenta de Bienes Raices</h2>
            <p>¡Hola <strong>${nombre}</strong>!</p>
            <p>Hemos recibico una solicitud de recuperacion de contraseña para tu cuenta de bienes racies, lo unico que tienes que hacer es hacer click debajo del enlace y recuperaras tu contraseña</p>
            <a href="${process.env.BACKEND_URL}:${process.env.PORT ?? 3000}/auth/passwordRecovery/${token}" 
                style="background-color: #ee7956; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px; font-weight: bold; display: inline-block;">
                Recuperar contraseña
            </a>
            <p>¿El correo no era para ti?, puedes hacer caso omiso si es el caso.</p>
            <div class="signature">
                <p>Saludos cordiales,</p>
                <img src="https://xdddd.s3.us-east-2.amazonaws.com/firma.png" alt="firma" width="200px" height="200px">
                <p class="name">Edwin Hernandez Campos</p>
